...
Measured with the transaction load test on an enterprise server with fast SSDs, throughput went up from about 5,300 to about 18,000 transactions per second. That factor of 3.4 takes a five-hour import down to about an hour and a half.
