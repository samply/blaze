FROM eclipse-temurin:25.0.3_9-jre-noble@sha256:1a99f30a84d58729f1184c1c693f25fb6f91970ddf05395515540bc5773b8edd
...
COPY target/blaze-1.11.0-standalone.jar /app/
...
CMD ["sh", "-c", "JAVA_TOOL_OPTIONS=\"${BASE_JAVA_TOOL_OPTIONS} ${JAVA_TOOL_OPTIONS}\" exec java -jar blaze-1.11.0-standalone.jar"]
