FROM eclipse-temurin:25.0.2_10-jre-noble@sha256:affd314e79fbb87dae2f15bbfdae4d1cdc6299626c19e98295186a5869c60801
...
COPY target/blaze-1.6.0-standalone.jar /app/
...
CMD ["sh", "-c", "JAVA_TOOL_OPTIONS=\"${BASE_JAVA_TOOL_OPTIONS} ${JAVA_TOOL_OPTIONS}\" exec java -jar blaze-1.6.0-standalone.jar"]
