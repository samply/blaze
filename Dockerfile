...
COPY target/blaze-1.5.1-standalone.jar /app/
...
CMD ["sh", "-c", "JAVA_TOOL_OPTIONS=\"${BASE_JAVA_TOOL_OPTIONS} ${JAVA_TOOL_OPTIONS}\" exec java -jar blaze-1.5.1-standalone.jar"]
