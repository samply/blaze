...
docker run -p 8080:8080 -v blaze-data:/app/data samply/blaze:0.9.0-alpha.22
```
...
```bash
wget https://github.com/samply/blaze/releases/download/v0.9.0-alpha.10/blaze-0.9.0-alpha.22-standalone.jar
java -jar blaze-0.9.0-alpha.22-standalone.jar -m blaze.core
```
...
```bash
STORAGE=standalone java -jar blaze-0.9.0-alpha.22-standalone.jar -m blaze.core
```
