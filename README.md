...
Latest release: [v0.11.0-alpha.7][5]
...
docker run -p 8080:8080 -v blaze-data:/app/data samply/blaze:0.11.0-alpha.7
```
...
[5]: <https://github.com/samply/blaze/releases/tag/v0.11.0-alpha.7>
