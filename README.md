...
Latest release: [v0.7.0-alpha7][5]
...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.7.0-alpha7
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.7.0-alpha7/blaze-0.7.0-alpha7-standalone.jar
java -jar blaze-0.7.0-alpha7-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.7.0-alpha7>
