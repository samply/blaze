...
Latest release: [v0.8.0-alpha.2][5]
...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.8.0-alpha.2
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.8.0-alpha.2/blaze-0.8.0-alpha.2-standalone.jar
java -jar blaze-0.8.0-alpha.2-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.8.0-alpha.2>
