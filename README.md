...
Latest release: [v0.8.0-alpha.8][5]
...
```bash
docker run -p 8080:8080 samply/blaze:0.8.0-alpha.8
```

### Java

```bash
wget https://github.com/samply/blaze/releases/download/v0.8.0-alpha.8/blaze-0.8.0-alpha.8-standalone.jar
java -jar blaze-0.8.0-alpha.8-standalone.jar
```
...
[5]: <https://github.com/samply/blaze/releases/tag/v0.8.0-alpha.8>
