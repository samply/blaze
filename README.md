...
Latest release: [v0.10.1-alpha.1][5]
...
docker run -p 8080:8080 -v blaze-data:/app/data samply/blaze:0.10.1-alpha.1
```
...
[5]: <https://github.com/samply/blaze/releases/tag/v0.10.1-alpha.1>
