...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.6.3
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.6.3/blaze-0.6.3-standalone.jar
java -jar blaze-0.6.3-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.6.3>
