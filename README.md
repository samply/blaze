...
Latest release: [v0.9.0-alpha.1][5]
...
```bash
docker run -p 8080:8080 samply/blaze:0.9.0-alpha.1
```

### Java

```bash
wget https://github.com/samply/blaze/releases/download/v0.9.0-alpha.1/blaze-0.9.0-alpha.1-standalone.jar
java -jar blaze-0.9.0-alpha.1-standalone.jar -m blaze.core
```
...
[5]: <https://github.com/samply/blaze/releases/tag/v0.9.0-alpha.1>
