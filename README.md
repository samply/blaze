...
Latest release: [v0.7.0-alpha.8][5]
...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.7.0-alpha.8
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.7.0-alpha.8/blaze-0.7.0-alpha.8-standalone.jar
java -jar blaze-0.7.0-alpha.8-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.7.0-alpha.8>
