...
Latest release: [v0.8.0-alpha.1][5]
...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.8.0-alpha.1
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.8.0-alpha.1/blaze-0.8.0-alpha.1-standalone.jar
java -jar blaze-0.8.0-alpha.1-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.8.0-alpha.1>
