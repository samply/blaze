...
Latest release: [v0.9.0-alpha.7][5]
...
```bash
docker run -p 8080:8080 -v <local-dir>:/data -e DB_DIR="/data/db" samply/blaze:0.9.0-alpha.7
```
...
docker run -p 8080:8080 -v ~/blaze-data:/data -e DB_DIR="/data/db" samply/blaze:0.9.0-alpha.7
```
...
```bash
docker run -p 8080:8080 -v blaze-data-volume:/app/data -e DB_DIR="/app/data/db" samply/blaze:0.9.0-alpha.7
```
...
```bash
wget https://github.com/samply/blaze/releases/download/v0.9.0-alpha.7/blaze-0.9.0-alpha.7-standalone.jar
java -jar blaze-0.9.0-alpha.7-standalone.jar -m blaze.core
```
...
[5]: <https://github.com/samply/blaze/releases/tag/v0.9.0-alpha.7>
