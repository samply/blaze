...
Latest release: [v0.8.0-alpha.4][5]
...
```bash
docker run -p 8080:8080 liferesearch/blaze:0.8.0-alpha.4
```

### Java

```bash
wget https://github.com/life-research/blaze/releases/download/v0.8.0-alpha.4/blaze-0.8.0-alpha.4-standalone.jar
java -jar blaze-0.8.0-alpha.4-standalone.jar
```
...
[5]: <https://github.com/life-research/blaze/releases/tag/v0.8.0-alpha.4>
