...
export default defineConfig({
  ...
  themeConfig: {
    ...
    socialLinks: [{ icon: "github", link: "https://github.com/samply/blaze" }],
    ...
    sidebar: [
            ...
            items: [
              {
                ...
                items: [
                  ...
                  {
                    text: "Delete History",
                    link: "/api/interaction/delete-history",
                  },
                  {
                    text: "History",
                    link: "/api/interaction/history-instance",
                  },
                ],
              },
              {
              ...
              },
              {
                ...
                items: [
                  {
                    text: "Capabilities",
                    link: "/api/interaction/capabilities",
                  },
          ...
          },
          {
            ...
            items: [
              ...
              },
              {
                ...
                items: [
                  {
                    text: "$evaluate-measure",
                    link: "/api/operation/measure-evaluate-measure",
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    text: "$everything",
                    link: "/api/operation/patient-everything",
                  },
              ...
              },
              {
                ...
                items: [
                  ...
                  {
                    text: "$validate-code",
                    link: "/api/operation/value-set-validate-code",
                  },
                ],
              },
            ],
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Standalone Backend Only",
            link: "/deployment/standalone-backend",
          },
          {
            text: "Distributed Backend Only",
      ...
      },
      {
        ...
        items: [
          ...
          {
            text: "Terminology Service",
            link: "/performance/terminology-service",
          },
        ],
      },
      {
        ...
        items: [
          { text: "Architecture", link: "/architecture" },
          {
            ...
            items: [
              ...
              {
                text: "FHIR Data Model",
                link: "/implementation/fhir-data-model",
              },
