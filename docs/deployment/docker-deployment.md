...
```sh
docker run -d --name blaze -p 8080:8080 -v blaze-data:/app/data samply/blaze:0.21
```
...
2023-06-09T08:30:30.126Z b45689460ff3 main INFO [blaze.core:70] - Successfully started 🔥 Blaze version 0.21.0 in 9.0 seconds
```
