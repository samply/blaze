...
```bash
docker run -d --name blaze -p 8080:8080 -v blaze-data:/app/data samply/blaze:0.10.3
```
...
2020-06-23 08:06:49.238+0000 73c1e4c03d80 INFO [blaze.core:63] - Successfully started Blaze version 0.10.3 in 24.9 seconds
```
