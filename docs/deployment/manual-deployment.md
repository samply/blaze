...
```sh
java -jar blaze-0.23.2-standalone.jar
```
...
```sh
STORAGE=standalone java -jar blaze-0.23.2-standalone.jar
```
...
2021-06-27T11:02:37.836Z ee086ef908c1 main INFO [blaze.core:67] - Successfully started Blaze version 0.23.2 in 8.2 seconds
```
