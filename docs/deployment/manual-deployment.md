...
Blaze runs on the JVM and comes as single JAR file. Download the most recent version [here](https://github.com/samply/blaze/releases/tag/v0.11.1). Look for `blaze-0.11.1-standalone.jar`.

After the download, you can start blaze with the following command (Linux, macOS):

```sh
java -jar blaze-0.11.1-standalone.jar -m blaze.core
```
...
```sh
STORAGE=standalone java -jar blaze-0.11.1-standalone.jar -m blaze.core
```
