...
Blaze runs on the JVM and comes as single JAR file. Download the most recent version [here](https://github.com/samply/blaze/releases/tag/v0.26.2). Look for `blaze-0.26.2-standalone.jar`.

After the download, you can start blaze with the following command (Linux, macOS):

```sh
java -jar blaze-0.26.2-standalone.jar
```
...
```sh
STORAGE=standalone java -jar blaze-0.26.2-standalone.jar
```
...
2021-06-27T11:02:37.836Z ee086ef908c1 main INFO [blaze.core:67] - Successfully started Blaze version 0.26.2 in 8.2 seconds
```
