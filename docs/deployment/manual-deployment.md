...
Blaze runs on the JVM and comes as single JAR file. Download the most recent version [here](https://github.com/samply/blaze/releases/tag/v0.11.0-alpha.3). Look for `blaze-0.11.0-alpha.3-standalone.jar`.

After the download, you can start blaze with the following command (Linux, macOS):

```bash
java -jar blaze-0.11.0-alpha.3-standalone.jar -m blaze.core
```
...
```bash
STORAGE=standalone java -jar blaze-0.11.0-alpha.3-standalone.jar -m blaze.core
```
...
2020-06-23 06:45:06.860+0000 my-server INFO [blaze.core:63] - Successfully started Blaze version 0.11.0-alpha.3 in 25,5 seconds
```
