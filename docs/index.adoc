...
The installation should work under Windows, Linux and MacOS. Both Datomic and Blaze need a current Java 8 JDK. Other Versions of Java aren't currently tested.
...
After the download, you can start blaze with the following command:
