...
Download the most recent version https://github.com/samply/blaze/releases/tag/v0.8.0-alpha.7[here].
...
After installation, please refer to the https://github.com/samply/blaze#usage[Usage] section of the README.
