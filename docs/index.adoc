...
Results of performance tests using https://github.com/tsenart/vegeta[vegeta] at 100 requests per second, creating 3000 resources each and warming up with one run.
...
|===
| Resource Type | Median | Q-95 | Q-99
| Patient | 7.5 ms | 10.8 ms | 17.4 ms
| Condition | 7.9 ms | 13.9 ms, 36.1 ms
| Observation | 8.2 ms | 14.4 ms | 27.7 ms
| Specimen | 8.0 ms | 12.9 ms | 25.3 ms
|===
