...
set title "Code, Date and Age Search 100k"
set xlabel 'System'
...
# Plot the data
plot 'code-date-age-search-100k.txt' using 6:xtic(1) every 2 ls 1 title 'hemoglobin', \
     'code-date-age-search-100k.txt' using 6:xtic(1) every 2::1 ls 2 title 'calcium', \
