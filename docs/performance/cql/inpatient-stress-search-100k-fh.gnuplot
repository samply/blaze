...
set output 'inpatient-stress-search-100k-fh.png'
...
set title "Inpatient Stress Search - Dataset 100k-fh"
set xlabel 'System'
...
# Plot the data
plot 'inpatient-stress-search-100k-fh.txt' using 7:xtic(3) ls 2 title '2 % hits'
