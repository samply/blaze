...
set output 'inpatient-stress-search-1M.png'
...
set title "Inpatient Stress Search - Dataset 1M"
set xlabel 'System'
...
# Plot the data
plot 'inpatient-stress-search-1M.txt' using 7:xtic(3) ls 2 title '1.6 % hits'
