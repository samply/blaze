...
set output 'medication-search-100k.png'
...
set title "Medication Search - Dataset 100k"
set xlabel 'System'
...
# Plot the data
plot 'medication-search-100k.txt' using 7:xtic(3) every 2 ls 1 title '1 % hits', \
     'medication-search-100k.txt' using 7:xtic(3) every 2::1 ls 2 title '7 % hits'
