...
set output 'medication-ten-search-100k.png'
...
set title "Medication Ten Search - Dataset 100k"
set xlabel 'System'
...
# Plot the data
plot 'medication-ten-search-100k.txt' using 7:xtic(3) ls 1 title '15 % hits'
