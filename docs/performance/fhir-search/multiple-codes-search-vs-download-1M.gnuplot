...
set output 'multiple-codes-search-vs-download-1M.png'
...
set title "Multiple Codes Search – ValueSet - Download - Dataset 1M"
set xlabel 'System'
...
# Plot the data
plot 'multiple-codes-search-vs-download-1M.txt' using 4:xtic(2) every 2 ls 1 title '10 codes', \
     'multiple-codes-search-vs-download-1M.txt' using 4:xtic(2) every 2::1 ls 2 title '100 codes'
