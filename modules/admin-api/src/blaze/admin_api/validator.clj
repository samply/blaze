...
(def ^:private profiles
  ...
  ["blaze/db/CodeSystem-ColumnFamily.json"
   ...
   "blaze/job/disk_perf/CodeSystem-DiskPerfJobOutput.json"
   "blaze/job/disk_perf/CodeSystem-DiskPerfJobParameter.json"
   "blaze/job/disk_perf/CodeSystem-DiskPerfPhase.json"
   "blaze/job/disk_perf/ValueSet-DiskPerfPhase.json"
   "blaze/job/disk_perf/CodeSystem-DiskPerfRating.json"
   "blaze/job/disk_perf/ValueSet-DiskPerfRating.json"
   "blaze/job/disk_perf/StructureDefinition-disk-perf-concurrency.json"
   "blaze/job/disk_perf/StructureDefinition-DiskPerfJob.json"
