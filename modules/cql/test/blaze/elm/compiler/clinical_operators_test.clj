...
(deftest compile-calculate-age-at-test
  ...
  (ctu/testing-binary-attach-cache elm/calculate-age-at)

  (ctu/testing-binary-precision-resolve-expr-ref elm/calculate-age-at "year" "month" "day")

  (ctu/testing-binary-precision-resolve-param elm/calculate-age-at "year" "month" "day")
