...
(deftest compile-interval-test
  (testing "Static"
    ...
    (testing "Date"
      (are [s e res] (= res (ctu/compile-binop elm/closed-interval elm/date s e))
        "2020" "2021" (interval #system/date"2020" #system/date"2021")))

    (testing "DateTime"
      (are [s e res] (= res (ctu/compile-binop elm/closed-interval elm/date-time s e))
...
(deftest compile-contains-test
  (testing "Interval"
    (testing "Integer"
      ...
      (ctu/testing-binary-null elm/contains interval-zero #elm/integer "1")))
  ...
  (testing "List"
    ...
    (ctu/testing-binary-null elm/contains #elm/list [] #elm/integer "1"))
