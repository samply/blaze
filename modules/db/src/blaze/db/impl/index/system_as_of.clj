...
(defn system-history
  "Returns a reducible collection of all historic resource handles of
  `batch-db` between `start-t` (inclusive), `start-tid` (optional,
  inclusive) and `start-id` (optional, inclusive)."
