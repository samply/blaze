...
(deftest ^:slow transact-create-property-test
  (doseq [gen `[fg/activity-definition fg/allergy-intolerance fg/bundle
                fg/code-system fg/condition fg/consent fg/diagnostic-report
                fg/encounter fg/library fg/medication-administration
                fg/observation fg/patient  fg/procedure fg/value-set]]
    (satisfies-prop 20
