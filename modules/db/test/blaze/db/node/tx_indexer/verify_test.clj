...
(def patient-0-v2 #fhir/map{:fhir/type :fhir/Patient :id "0" :gender #fhir/code "male"})
(def patient-1 #fhir/map{:fhir/type :fhir/Patient :id "1"})
(def observation-0 #fhir/map{:fhir/type :fhir/Observation :id "0"
                             :subject #fhir/Reference{:reference #fhir/string "Patient/0"}})
(def observation-1 #fhir/map{:fhir/type :fhir/Observation :id "1"
                             :subject #fhir/Reference{:reference #fhir/string "Patient/0"}})
(def allergy-intolerance-0 #fhir/map{:fhir/type :fhir/AllergyIntolerance :id "0"
...
(deftest verify-delete-history-test
  ...
  (testing "one patient"
    ...
    (testing "with two versions"
      (let [patient-v1 #fhir/map{:fhir/type :fhir/Patient :id "0" :active #fhir/boolean false}
            patient-v2 #fhir/map{:fhir/type :fhir/Patient :id "0" :active #fhir/boolean true}
    ...
    (testing "with three versions"
      (let [patient-v1 #fhir/map{:fhir/type :fhir/Patient :id "0" :active #fhir/boolean false}
            patient-v2 #fhir/map{:fhir/type :fhir/Patient :id "0" :active #fhir/boolean true}
            patient-v3 #fhir/map{:fhir/type :fhir/Patient :id "0" :active #fhir/boolean false}
            hash-v1 (hash/generate patient-v1)
