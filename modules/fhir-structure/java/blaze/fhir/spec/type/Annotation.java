...
public final class Annotation extends Element implements Complex, ExtensionValue {
    ...
    public static Annotation create(IPersistentMap m) {
        return new Annotation((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
                (Base) m.valAt(AUTHOR), (DateTime) m.valAt(TIME), (Markdown) m.valAt(TEXT));
    }

    public static IPersistentVector getBasis() {
        return RT.vector(Symbol.intern(null, "id"), Symbol.intern(null, "extension"), Symbol.intern(null, "author"),
                Symbol.intern(null, "time"), Symbol.intern(null, "text"));
    }
