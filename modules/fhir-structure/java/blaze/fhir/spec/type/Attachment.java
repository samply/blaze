...
public final class Attachment extends Element implements Complex, ExtensionValue {
    ...
    public static Attachment create(IPersistentMap m) {
        return new Attachment((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
                (Code) m.valAt(CONTENT_TYPE), (Code) m.valAt(LANGUAGE), (Base64Binary) m.valAt(DATA),
                (Url) m.valAt(URL), (UnsignedInt) m.valAt(SIZE), (Base64Binary) m.valAt(HASH),
                (String) m.valAt(TITLE), (DateTime) m.valAt(CREATION));
    }

    public static IPersistentVector getBasis() {
        return RT.vector(Symbol.intern(null, "id"), Symbol.intern(null, "extension"), Symbol.intern(null, "contentType"),
                Symbol.intern(null, "language"), Symbol.intern(null, "data"), Symbol.intern(null, "url"),
                Symbol.intern(null, "size"), Symbol.intern(null, "hash"), Symbol.intern(null, "title"),
                Symbol.intern(null, "creation"));
    }
