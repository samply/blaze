...
public final class BundleEntrySearch extends Element implements Complex {
    ...
    public BundleEntrySearch(java.lang.String id, PersistentVector extension, Code mode, Decimal score) {
        super(id, extension);
        this.mode = mode;
        this.score = score;
    }
    ...
    public static BundleEntrySearch create(IPersistentMap m) {
        return new BundleEntrySearch((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
                (Code) m.valAt(MODE), (Decimal) m.valAt(SCORE));
    }

    public static IPersistentVector getBasis() {
        return RT.vector(Symbol.intern(null, "id"), Symbol.intern(null, "extension"), Symbol.intern(null, "mode"),
                Symbol.intern(null, "score"));
    }
    ...
    public IPersistentCollection empty() {
        return new BundleEntrySearch(null, null, null, null);
    }
    ...
    public BundleEntrySearch assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new BundleEntrySearch(id, (PersistentVector) val, mode, score);
