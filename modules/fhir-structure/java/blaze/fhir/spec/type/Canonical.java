...
public final class Canonical extends Element implements Primitive {
    ...
    public Canonical(java.lang.String id, List<Extension> extension, java.lang.String value) {
        super(id, extension);
        this.value = value;
    ...
    public static Canonical create(IPersistentMap m) {
        return new Canonical((java.lang.String) m.valAt(ID), Base.listFrom(m, EXTENSION),
    ...
    public IPersistentCollection empty() {
        return new Canonical(null, PersistentVector.EMPTY, null);
    }
    ...
    public Canonical assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Canonical(id, (List<Extension>) val, value);
