...
public final class Code extends Element implements Primitive {
    ...
    public static Code create(IPersistentMap m) {
        return new Code((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION), (java.lang.String) m.valAt(VALUE));
    }
    ...
    public IPersistentCollection empty() {
        return new Code(null, null, null);
    }

    @Override
    public Code assoc(Object key, Object val) {
        if (key == VALUE) return new Code(id, extension, (java.lang.String) val);
        if (key == EXTENSION) return new Code(id, (PersistentVector) val, value);
