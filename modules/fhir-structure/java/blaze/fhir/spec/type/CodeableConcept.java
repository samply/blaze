...
public final class CodeableConcept extends Element implements Complex, ExtensionValue {
    ...
    public static CodeableConcept create(IPersistentMap m) {
        return new CodeableConcept((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
                (PersistentVector) m.valAt(CODING), (String) m.valAt(TEXT));
    }

    public static IPersistentVector getBasis() {
        return RT.vector(Symbol.intern(null, "id"), Symbol.intern(null, "extension"), Symbol.intern(null, "coding"),
                Symbol.intern(null, "text"));
    }
    ...
    public void serializeAsJsonValue(JsonGenerator generator) throws IOException {
        ...
        if (coding != null && !coding.isEmpty()) {
            ...
            for (Object coding : coding) {
                ((Coding) coding).serializeAsJsonValue(generator);
            }
