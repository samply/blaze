...
public final class Coding extends Element implements Complex, ExtensionValue {
    ...
    public static Coding create(IPersistentMap m) {
        return new Coding((java.lang.String) m.valAt(ID), Base.listFrom(m, EXTENSION),
    ...
    public boolean isInterned() {
        return isBaseInterned() && Base.isInterned(system) && Primitive.isBaseInterned(version) &&
                Base.isInterned(code) && Primitive.isBaseInterned(display) &&
                Base.isInterned(userSelected);
    }
    ...
    public IPersistentCollection empty() {
        return new Coding(null, PersistentVector.EMPTY, null, null, null, null, null);
    }
    ...
    public Coding assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new Coding(id, (List<Extension>) val, system, version, code, display, userSelected);
