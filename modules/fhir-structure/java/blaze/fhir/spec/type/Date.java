...
public final class Date extends Element implements Primitive {
    ...
    public Date(java.lang.String id, PersistentVector extension, blaze.fhir.spec.type.system.Date value) {
        super(id, extension);
        this.value = value;
    }

    public static Date create(IPersistentMap m) {
        return new Date((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION), (blaze.fhir.spec.type.system.Date) m.valAt(VALUE));
    }
    ...
    public Date assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Date(id, (PersistentVector) val, value);
