...
public final class Dosage extends AbstractBackboneElement implements Complex, ExtensionValue {
     ...
     * 4 byte - sequence reference
     * 4 byte - text reference
     * 4 byte - additionalInstruction reference
     * 4 byte - patientInstruction reference
     * 4 byte - timing reference
     * 4 byte - asNeeded reference
     * 4 byte - site reference
     * 4 byte - route reference
     * 4 byte - method reference
     * 4 byte - doseAndRate reference
     * 4 byte - maxDosePerPeriod reference
     * 4 byte - maxDosePerAdministration reference
     * 4 byte - maxDosePerLifetime reference
     * 4 byte - padding
     */
    ...
    public static class DoseAndRate extends AbstractElement implements Complex {
         ...
         * 4 byte - dose reference
         * 4 byte - rate reference
         */
