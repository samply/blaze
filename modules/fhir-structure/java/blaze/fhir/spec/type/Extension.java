...
public final class Extension extends Element implements Complex {
    ...
    public Extension(java.lang.String id, List<Extension> extension, java.lang.String url, ExtensionValue value) {
        super(id, extension);
        this.url = url;
        this.value = value;
    }
    ...
    public static Extension create(IPersistentMap m) {
        return new Extension((java.lang.String) m.valAt(ID), Base.listFrom(m, EXTENSION), (java.lang.String) m.valAt(URL),
    ...
    public boolean isInterned() {
        return isBaseInterned() && Base.isInterned(value);
    }
    ...
    public Extension empty() {
        return new Extension(null, PersistentVector.EMPTY, null, null);
    }
    ...
    public Extension assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Extension(id, (List<Extension>) val, url, value);
