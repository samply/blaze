...
public final class Id extends Element implements Primitive {
    ...
    public Id(java.lang.String id, PersistentVector extension, java.lang.String value) {
        super(id, extension);
        this.value = value;
    }

    public static Id create(IPersistentMap m) {
        return new Id((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION), (java.lang.String) m.valAt(VALUE));
    }
    ...
    public Id assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Id(id, (PersistentVector) val, value);
