...
public final class Meta extends Element implements Complex, ExtensionValue {
    ...
    public Meta(java.lang.String id, PersistentVector extension, Id versionId, Instant lastUpdated, Uri source, List<Canonical> profile, List<Coding> security, List<Coding> tag) {
        super(id, extension);
    ...
    public static Meta create(IPersistentMap m) {
        return new Meta((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
                (Id) m.valAt(VERSION_ID), (Instant) m.valAt(LAST_UPDATED), (Uri) m.valAt(SOURCE),
                (List<Canonical>) m.valAt(PROFILE), (List<Coding>) m.valAt(SECURITY), (List<Coding>) m.valAt(TAG));
    }

    public static IPersistentVector getBasis() {
        return RT.vector(Symbol.intern(null, "id"), Symbol.intern(null, "extension"), Symbol.intern(null, "versionId"),
                Symbol.intern(null, "lastUpdated"), Symbol.intern(null, "source"), Symbol.intern(null, "profile"),
                Symbol.intern(null, "security"), Symbol.intern(null, "tag"));
    }
    ...
    public IPersistentCollection empty() {
        return new Meta(null, null, null, null, null, null, null, null);
    }
    ...
    public Meta assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new Meta(id, (PersistentVector) val, versionId, lastUpdated, source, profile, security, tag);
        if (key == VERSION_ID)
