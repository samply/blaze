...
public final class Quantity extends Element implements Complex, ExtensionValue {
    ...
    public Quantity(java.lang.String id, List<Extension> extension, Decimal value, Code comparator, String unit,
    ...
    public static Quantity create(IPersistentMap m) {
        return new Quantity((java.lang.String) m.valAt(ID), Base.listFrom(m, EXTENSION),
    ...
    public boolean isInterned() {
        return isBaseInterned() && Base.isInterned(value) && Base.isInterned(comparator) &&
                Primitive.isBaseInterned(unit) && Base.isInterned(system) && Base.isInterned(code);
    }
    ...
    public IPersistentCollection empty() {
        return new Quantity(null, PersistentVector.EMPTY, null, null, null, null, null);
    }
    ...
    public Quantity assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new Quantity(id, (List<Extension>) val, value, comparator, unit, system, code);
        if (key == VALUE)
