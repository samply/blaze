...
public final class Range extends Element implements Complex, ExtensionValue {
    ...
    public Range(java.lang.String id, PersistentVector extension, Quantity low, Quantity high) {
        super(id, extension);
        this.low = low;
        this.high = high;
    }
    ...
    public static Range create(IPersistentMap m) {
        return new Range((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
    ...
    public Range assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new Range(id, (PersistentVector) val, low, high);
        if (key == LOW)
