...
public final class Ratio extends Element implements Complex, ExtensionValue {
    ...
    public Ratio(java.lang.String id, PersistentVector extension, Quantity numerator, Quantity denominator) {
        super(id, extension);
    ...
    public static Ratio create(IPersistentMap m) {
        return new Ratio((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
    ...
    public IPersistentCollection empty() {
        return new Ratio(null, null, null, null);
    }
    ...
    public Ratio assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new Ratio(id, (PersistentVector) val, numerator, denominator);
        if (key == NUMERATOR)
