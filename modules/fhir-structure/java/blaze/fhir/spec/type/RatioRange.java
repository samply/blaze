...
public final class RatioRange extends Element implements Complex, ExtensionValue {
    ...
    public RatioRange(java.lang.String id, PersistentVector extension, Quantity lowNumerator, Quantity highNumerator, Quantity denominator) {
        super(id, extension);
    ...
    public static RatioRange create(IPersistentMap m) {
        return new RatioRange((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION),
    ...
    public IPersistentCollection empty() {
        return new RatioRange(null, null, null, null, null);
    }
    ...
    public RatioRange assoc(Object key, Object val) {
        ...
        if (key == EXTENSION)
            return new RatioRange(id, (PersistentVector) val, lowNumerator, highNumerator, denominator);
