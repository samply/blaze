...
public final class Signature extends AbstractElement implements Complex, ExtensionValue {
     ...
     * 4 byte - who reference
     * 4 byte - onBehalfOf reference
     * 4 byte - targetFormat reference
     * 4 byte - sigFormat reference
    ...
    private static final SerializedString FIELD_NAME_WHO = new SerializedString("who");
    private static final SerializedString FIELD_NAME_ON_BEHALF_OF = new SerializedString("onBehalfOf");
    ...
    public void serializeAsJsonValue(JsonGenerator generator) throws IOException {
        ...
        if (who != null) {
            generator.writeFieldName(FIELD_NAME_WHO);
            who.serializeAsJsonValue(generator);
        }
        if (onBehalfOf != null) {
            generator.writeFieldName(FIELD_NAME_ON_BEHALF_OF);
            onBehalfOf.serializeAsJsonValue(generator);
        }
