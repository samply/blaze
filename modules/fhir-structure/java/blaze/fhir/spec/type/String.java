...
public final class String extends Element implements Primitive {
    ...
    public String(java.lang.String id, PersistentVector extension, java.lang.String value) {
        super(id, extension);
        this.value = value;
    }

    public static String create(IPersistentMap m) {
        return new String((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION), (java.lang.String) m.valAt(VALUE));
    }
    ...
    public String assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new String(id, (PersistentVector) val, value);
