...
public final class Time extends Element implements Primitive {
    ...
    public Time(java.lang.String id, PersistentVector extension, LocalTime value) {
        super(id, extension);
        this.value = value;
    }

    public static Time create(IPersistentMap m) {
        return new Time((java.lang.String) m.valAt(ID), (PersistentVector) m.valAt(EXTENSION), (LocalTime) m.valAt(VALUE));
    }
    ...
    public Time assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Time(id, (PersistentVector) val, value);
    ...
    public void serializeJsonPrimitiveValue(JsonGenerator generator) throws IOException {
        if (hasValue()) {
            generator.writeString(Times.toString(value));
        } else {
            generator.writeNull();
        }
    }
