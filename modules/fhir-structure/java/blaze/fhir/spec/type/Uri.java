...
public final class Uri extends Element implements Primitive {
    ...
    public Uri(java.lang.String id, List<Extension> extension, java.lang.String value) {
        super(id, extension);
        this.value = value;
    ...
    public static Uri create(IPersistentMap m) {
        return new Uri((java.lang.String) m.valAt(ID), Base.listFrom(m, EXTENSION),
    ...
    public Uri assoc(Object key, Object val) {
        ...
        if (key == EXTENSION) return new Uri(id, (List<Extension>) val, value);
