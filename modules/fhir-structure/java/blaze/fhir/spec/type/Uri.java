...
public final class Uri implements PrimitiveType<String> {

    public static final StdSerializer<Uri> SERIALIZER = new StdSerializer<>(Uri.class) {
    ...
    private static final Keyword TYPE = RT.keyword("fhir", "uri");
    ...
    public Uri(String value) {
        this.value = Objects.requireNonNull(value, "Uri.url can't be null.");
    }
