(ns blaze.fhir.spec.type
  ...
  (:import
   [blaze.fhir.spec.type
    ...
    Canonical Code CodeableConcept Coding ContactDetail ContactPoint Contributor Count Date
    DateTime Decimal Distance Duration Expression Extension HumanName Id
    Identifier Instant Markdown Meta Oid Period PositiveInt Primitive Quantity
    Range Ratio Reference RelatedArtifact SampledData Signature String$Interned
    String$Normal Time Timing Timing$Repeat UnsignedInt Uri Uri$Interned
    Uri$Normal Url Uuid Xhtml]
