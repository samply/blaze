...
#_(s/fdef type/contributor
    :args (s/cat :x map?))

(s/fdef type/count
  :args (s/cat :x map?))

#_(s/fdef type/data-requirement
    :args (s/cat :x map?))

(s/fdef type/distance
  :args (s/cat :x map?))

#_(s/fdef type/dosage
    :args (s/cat :x map?))
...
#_(s/fdef type/parameter-definition
    :args (s/cat :x map?))
...
#_(s/fdef type/trigger-definition
    :args (s/cat :x map?))

#_(s/fdef type/usage-context
    :args (s/cat :x map?))
