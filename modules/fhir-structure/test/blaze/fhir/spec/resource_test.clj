...
(deftest parse-json-patient-test
  ...
  (testing "wrong value type"
    (given-parse-json "Patient"
      {:id 0}
      ::anom/category := ::anom/incorrect
      ::anom/message := "Invalid JSON representation of a resource. Expected token VALUE_STRING but was token VALUE_NUMBER_INT at [Source: REDACTED (`StreamReadFeature.INCLUDE_SOURCE_IN_LOCATION` disabled); line: 1, column: 8]"))
    ...
    (testing "invalid"
      (given-parse-json "Extension"
        {:url "url-204835"
         :valueDate "foo"}
        ::anom/category := ::anom/incorrect
        ::anom/message := "Invalid JSON representation of a resource. Can't parse `foo` as System.Date because it doesn't has the right length.")

      (given-parse-json "Extension"
        {:url "url-204835"
         :valueDate "abcd"}
        ::anom/category := ::anom/incorrect
        ::anom/message := "Invalid JSON representation of a resource. Invalid date component: For input string: \"abcd\"")

      (given-parse-json "Extension"
        {:url "url-204835"
         :valueDate "2025-02-29"}
        ::anom/category := ::anom/incorrect
        ::anom/message := "Invalid JSON representation of a resource. Invalid date 'February 29' as '2025' is not a leap year")))
    ...
    (testing "invalid"
      (given-parse-json "Extension"
        {:url "url-204835"
         :valueDateTime "foo"}
        ::anom/category := ::anom/incorrect
        ::anom/message := "Invalid JSON representation of a resource. Can't parse `foo` as System.DateTime because it doesn't has the right length.")
    ...
    (testing "invalid"
      (given-parse-json "Extension"
        {:url "url-204835"
         :valueTime "15:60:00"}
        ::anom/category := ::anom/incorrect
        ::anom/message := "Invalid JSON representation of a resource. Text '15:60:00' could not be parsed: Invalid value for MinuteOfHour (valid values 0 - 59): 60")))
