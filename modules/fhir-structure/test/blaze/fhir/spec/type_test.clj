...
(deftest age-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Age{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Age{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest annotation-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Annotation{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Annotation{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/Annotation{:text #fhir/markdown "foo"}
      #fhir/Annotation{:text #fhir/markdown "foo"}))
...
(deftest contact-detail-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/ContactDetail{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/ContactDetail{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/ContactDetail{:name #fhir/string "foo"}
      #fhir/ContactDetail{:name #fhir/string "foo"}))
...
(deftest contact-point-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/ContactPoint{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/ContactPoint{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest contributor-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/Contributor{:id "foo"}
      #fhir/Contributor{:id "foo"}

      #fhir/Contributor{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Contributor{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/Contributor{:name #fhir/string "foo"}
      #fhir/Contributor{:name #fhir/string "foo"}))
...
(deftest count-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Count{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Count{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest data-requirement-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/DataRequirement{:id "foo"}
      #fhir/DataRequirement{:id "foo"}

      #fhir/DataRequirement{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/DataRequirement{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest data-requirement-code-filter-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir.DataRequirement/codeFilter{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir.DataRequirement/codeFilter{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir.DataRequirement/codeFilter{:path #fhir/string "foo"}
      #fhir.DataRequirement/codeFilter{:path #fhir/string "foo"}))
...
(deftest data-requirement-date-filter-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir.DataRequirement/dateFilter{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir.DataRequirement/dateFilter{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir.DataRequirement/dateFilter{:path #fhir/string "foo"}
      #fhir.DataRequirement/dateFilter{:path #fhir/string "foo"}))
  ...
  (testing "hash-into"
    (are [x hex] (= hex (murmur3 x))
      ...
      #fhir.DataRequirement/dateFilter{:id "id-151412"}
      "b26a513c"

      #fhir.DataRequirement/dateFilter{:extension [#fhir/Extension{}]}
      "a09a0a1a"))
...
(deftest data-requirement-sort-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir.DataRequirement/sort{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir.DataRequirement/sort{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir.DataRequirement/sort{:path #fhir/string "foo"}
      #fhir.DataRequirement/sort{:path #fhir/string "foo"}))
  ...
  (testing "hash-into"
    (are [x hex] (= hex (murmur3 x))
      ...
      #fhir.DataRequirement/sort{:id "id-151412"}
      "515b44a2"

      #fhir.DataRequirement/sort{:extension [#fhir/Extension{}]}
      "8af9d584"))
...
(deftest distance-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Distance{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Distance{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest duration-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/Duration{:id "foo"}
      #fhir/Duration{:id "foo"}

      #fhir/Duration{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Duration{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
...
(deftest expression-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Expression{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Expression{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/Expression{:expression #fhir/string "foo"}
      #fhir/Expression{:expression #fhir/string "foo"}))
...
(deftest dosage-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Dosage{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Dosage{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/Dosage{:text #fhir/string "foo"}
      #fhir/Dosage{:text #fhir/string "foo"}))
...
(deftest dosage-dose-and-rate-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir.Dosage/doseAndRate{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir.Dosage/doseAndRate{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}))
...
(deftest related-artifact-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/RelatedArtifact{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/RelatedArtifact{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/RelatedArtifact{:display #fhir/string "foo"}
      #fhir/RelatedArtifact{:display #fhir/string "foo"}))
...
(deftest sampled-data-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/SampledData{:id "foo"}
      #fhir/SampledData{:id "foo"}

      #fhir/SampledData{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/SampledData{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/SampledData{:data #fhir/string "1 2 3"}
      #fhir/SampledData{:data #fhir/string "1 2 3"}))
  ...
  (testing "hash-into"
    (are [x hex] (= hex (murmur3 x))
      ...
      #fhir/SampledData{:id "id-151412"}
      "bad5122f"

      #fhir/SampledData{:extension [#fhir/Extension{}]}
      "dec78ae4"

      #fhir/SampledData{:origin #fhir/Quantity{:value #fhir/decimal 1M}}
      "537217b3"
...
(deftest signature-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/Signature{:id "foo"}
      #fhir/Signature{:id "foo"}

      #fhir/Signature{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Signature{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/Signature{:type [#fhir/Coding{:code #fhir/code "foo"}]}
      #fhir/Signature{:type [#fhir/Coding{:code #fhir/code "foo"}]}))
  ...
  (testing "hash-into"
    (are [x hex] (= hex (murmur3 x))
      ...
      #fhir/Signature{:id "id-151412"}
      "2ef7db74"

      #fhir/Signature{:extension [#fhir/Extension{}]}
      "d7e8cf07"

      #fhir/Signature{:type [#fhir/Coding{:code #fhir/code "code-151510"}]}
      "a88dc01e"

      #fhir/Signature{:when #fhir/instant #system/date-time "2022-04-20T11:58:38.070Z"}
      "f9c13eef"))
...
(deftest timing-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/Timing{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/Timing{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}))
...
(deftest timing-repeat-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir.Timing/repeat{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir.Timing/repeat{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}))
...
(deftest trigger-definition-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      ...
      #fhir/TriggerDefinition{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/TriggerDefinition{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/TriggerDefinition{:name #fhir/string "foo"}
      #fhir/TriggerDefinition{:name #fhir/string "foo"}))
...
(deftest usage-context-test
  ...
  (testing "interning"
    (are [x y] (not-interned? x y)
      #fhir/UsageContext{:id "foo"}
      #fhir/UsageContext{:id "foo"}

      #fhir/UsageContext{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}
      #fhir/UsageContext{:extension [#fhir/Extension{:url "foo" :value #fhir/string "barbar"}]}

      #fhir/UsageContext{:code #fhir/Coding{:code #fhir/code "foo"}}
      #fhir/UsageContext{:code #fhir/Coding{:code #fhir/code "foo"}}))
  ...
  (testing "hash-into"
    (are [x hex] (= hex (murmur3 x))
      ...
      #fhir/UsageContext{:id "id-151412"}
      "f2c237b0"

      #fhir/UsageContext{:extension [#fhir/Extension{}]}
      "75c73fa9"

      #fhir/UsageContext{:code #fhir/Coding{:code #fhir/code "code-151510"}}
      "a1a17ce0"

      #fhir/UsageContext{:value #fhir/CodeableConcept{:text #fhir/string "text-151545"}}
      "b773268e"))
