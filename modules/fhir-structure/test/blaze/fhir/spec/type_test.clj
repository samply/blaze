...
(deftest integer-test
  ...
  (testing "assoc value"
    (is (= #fhir/integer 2 (assoc #fhir/integer 1 :value (int 2)))))
...
(deftest canonical-test
  ...
  (testing "mem-size"
    (are [s mem-size] (= mem-size (Base/memSize s))
      ...
      #fhir/canonical{:id "foo" :value ""} 144))
...
(deftest unsignedInt-test
  ...
  (testing "assoc value"
    (testing "non-extended"
      (is (= (assoc #fhir/unsignedInt 1 :value (int 2))
             #fhir/unsignedInt 2)))

    (testing "already extended"
      (is (= (assoc #fhir/unsignedInt{:id "foo"} :value (int 1))
...
(deftest positiveInt-test
  ...
  (testing "assoc value"
    (testing "non-extended"
      (is (= (assoc #fhir/positiveInt 1 :value (int 2))
             #fhir/positiveInt 2)))

    (testing "already extended"
      (is (= (assoc #fhir/positiveInt{:id "foo"} :value (int 1))
...
(deftest bundle-entry-search-test
  (testing "type"
    (is (= :fhir.Bundle.entry/search (:fhir/type #fhir/BundleEntrySearch{}))))
