...
(deftest ^:mem-size data-requirement-mem-size-test
  (satisfies-prop 50
    (prop/for-all [source (gen/fmap write-cbor (fg/data-requirement))]
      (>= (Base/memSize (parse-cbor "DataRequirement" source))
          (mem/total-size* (parse-cbor "DataRequirement" source)
                           (parse-cbor "DataRequirement" source)))))
...
(deftest ^:mem-size dosage-mem-size-test
  (satisfies-prop 50
    (prop/for-all [source (gen/fmap write-cbor (fg/dosage))]
      (>= (Base/memSize (parse-cbor "Dosage" source))
          (mem/total-size* (parse-cbor "Dosage" source)
                           (parse-cbor "Dosage" source)))))
...
(deftest ^:mem-size money-mem-size-test
  (satisfies-prop 50
    (prop/for-all [source (gen/fmap write-cbor (fg/money))]
      (>= (Base/memSize (parse-cbor "Money" source))
          (mem/total-size* (parse-cbor "Money" source)
                           (parse-cbor "Money" source))))))
...
(deftest ^:mem-size parameter-definition-mem-size-test
  (satisfies-prop 50
    (prop/for-all [source (gen/fmap write-cbor (fg/parameter-definition))]
      (>= (Base/memSize (parse-cbor "ParameterDefinition" source))
          (mem/total-size* (parse-cbor "ParameterDefinition" source)
                           (parse-cbor "ParameterDefinition" source))))))
...
(deftest ^:mem-size trigger-definition-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/trigger-definition))]
      (>= (Base/memSize (parse-cbor "TriggerDefinition" source))
          (mem/total-size* (parse-cbor "TriggerDefinition" source)
                           (parse-cbor "TriggerDefinition" source)))))
...
(deftest ^:mem-size activity-definition-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/activity-definition))]
      (>= (Base/memSize (parse-cbor "ActivityDefinition" source))
          (mem/total-size* (parse-cbor "ActivityDefinition" source)
                           (parse-cbor "ActivityDefinition" source))))))
...
(deftest ^:mem-size claim-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/claim))]
      (>= (Base/memSize (parse-cbor "Claim" source))
          (mem/total-size* (parse-cbor "Claim" source)
                           (parse-cbor "Claim" source))))))
...
(deftest ^:mem-size consent-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/consent))]
      (>= (Base/memSize (parse-cbor "Consent" source))
          (mem/total-size* (parse-cbor "Consent" source)
                           (parse-cbor "Consent" source))))))
...
(deftest ^:mem-size imaging-study-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/imaging-study))]
      (>= (Base/memSize (parse-cbor "ImagingStudy" source))
          (mem/total-size* (parse-cbor "ImagingStudy" source)
                           (parse-cbor "ImagingStudy" source))))))
...
(deftest ^:mem-size library-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/library))]
      (>= (Base/memSize (parse-cbor "Library" source))
          (mem/total-size* (parse-cbor "Library" source)
                           (parse-cbor "Library" source))))))
...
(deftest ^:mem-size medication-administration-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/medication-administration))]
      (>= (Base/memSize (parse-cbor "MedicationAdministration" source))
          (mem/total-size* (parse-cbor "MedicationAdministration" source)
                           (parse-cbor "MedicationAdministration" source))))))
...
(deftest ^:mem-size task-mem-size-test
  (satisfies-prop 20
    (prop/for-all [source (gen/fmap write-cbor (fg/task))]
      (>= (Base/memSize (parse-cbor "Task" source))
          (mem/total-size* (parse-cbor "Task" source)
                           (parse-cbor "Task" source))))))
