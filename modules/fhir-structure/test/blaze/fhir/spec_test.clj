...
(deftest annotation-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "Annotation" json))
        {}
        #fhir/Annotation{}

        {:id "id-151304"}
        #fhir/Annotation{:id "id-151304"}

        {:extension [{}]}
        #fhir/Annotation{:extension [#fhir/Extension{}]}

        {:text "text-114515"}
        #fhir/Annotation{:text #fhir/markdown "text-114515"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/Annotation{:id "id-134428"}
        {:id "id-134428"}

        #fhir/Annotation{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/Annotation{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "CodeableConcept" json))
        ...
        {:id "id-151304"}
        #fhir/CodeableConcept{:id "id-151304"}
...
(deftest contact-detail-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "ContactDetail" json))
        {}
        #fhir/ContactDetail{}

        {:id "id-151304"}
        #fhir/ContactDetail{:id "id-151304"}

        {:extension [{}]}
        #fhir/ContactDetail{:extension [#fhir/Extension{}]}

        {:name "name-114515"}
        #fhir/ContactDetail{:name #fhir/string "name-114515"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/ContactDetail{:id "id-134428"}
        {:id "id-134428"}

        #fhir/ContactDetail{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/ContactDetail{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
...
(deftest contact-point-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "ContactPoint" json))
        {}
        #fhir/ContactPoint{}

        {:id "id-151304"}
        #fhir/ContactPoint{:id "id-151304"}

        {:extension [{}]}
        #fhir/ContactPoint{:extension [#fhir/Extension{}]}

        {:value "value-114515"}
        #fhir/ContactPoint{:value #fhir/string "value-114515"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/ContactPoint{:id "id-134428"}
        {:id "id-134428"}

        #fhir/ContactPoint{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/ContactPoint{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "Contributor" json))
        ...
        {:name "name-114515"}
        #fhir/Contributor{:name #fhir/string "name-114515"})))
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "Dosage" json))
        ...
        {:id "id-151304"}
        #fhir/Dosage{:id "id-151304"}

        {:extension [{}]}
        #fhir/Dosage{:extension [#fhir/Extension{}]}
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/Dosage{:id "id-134428"}
        {:id "id-134428"}

        #fhir/Dosage{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/Dosage{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/Meta{:lastUpdated #fhir/instant #system/date-time "1970-01-01T00:00:00Z"}
        {:lastUpdated "1970-01-01T00:00:00Z"}
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "ParameterDefinition" json))
        ...
        {:id "id-151304"}
        #fhir/ParameterDefinition{:id "id-151304"}
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/ParameterDefinition{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
...
(deftest related-artifact-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "RelatedArtifact" json))
        {}
        #fhir/RelatedArtifact{}

        {:id "id-151304"}
        #fhir/RelatedArtifact{:id "id-151304"}

        {:extension [{}]}
        #fhir/RelatedArtifact{:extension [#fhir/Extension{}]}

        {:display "display-114515"}
        #fhir/RelatedArtifact{:display #fhir/string "display-114515"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/RelatedArtifact{:id "id-134428"}
        {:id "id-134428"}

        #fhir/RelatedArtifact{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/RelatedArtifact{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
...
(deftest sampled-data-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "SampledData" json))
        {}
        #fhir/SampledData{}

        {:id "id-151304"}
        #fhir/SampledData{:id "id-151304"}

        {:extension [{}]}
        #fhir/SampledData{:extension [#fhir/Extension{}]}

        {:data "data-161138"}
        #fhir/SampledData{:data #fhir/string "data-161138"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/SampledData{:id "id-134428"}
        {:id "id-134428"}

        #fhir/SampledData{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/SampledData{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
...
(deftest timing-repeat-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "Timing.repeat" json))
        {}
        #fhir.Timing/repeat{}

        {:id "id-151304"}
        #fhir.Timing/repeat{:id "id-151304"}

        {:extension [{}]}
        #fhir.Timing/repeat{:extension [#fhir/Extension{}]}

        {:count 1}
        #fhir.Timing/repeat{:count #fhir/positiveInt 1})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir.Timing/repeat{:id "id-134428"}
        {:id "id-134428"}

        #fhir.Timing/repeat{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir.Timing/repeat{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
...
(deftest trigger-definition-test
  ...
  (testing "parsing"
    (testing "JSON"
      (are [json fhir] (= fhir (write-parse-json "TriggerDefinition" json))
        {}
        #fhir/TriggerDefinition{}

        {:id "id-151304"}
        #fhir/TriggerDefinition{:id "id-151304"}

        {:extension [{}]}
        #fhir/TriggerDefinition{:extension [#fhir/Extension{}]}

        {:name "name-114845"}
        #fhir/TriggerDefinition{:name #fhir/string "name-114845"})))
  ...
  (testing "writing"
    (testing "JSON"
      (are [fhir json] (= json (write-read-json fhir))
        ...
        #fhir/TriggerDefinition{:id "id-134428"}
        {:id "id-134428"}

        #fhir/TriggerDefinition{:extension [#fhir/Extension{}]}
        {:extension [{}]}

        #fhir/TriggerDefinition{:extension [#fhir/Extension{} #fhir/Extension{}]}
        {:extension [{} {}]}
