...
{#if job.status === 'completed'}
	<svg
		...
		viewBox="0 0 24 24"
		fill="currentColor"
		class="w-6 h-12 text-center text-green-600"
	>
		<path
			fill-rule="evenodd"
...
{:else if job.status === 'failed'}
	<svg
		...
		viewBox="0 0 24 24"
		fill="currentColor"
		class="w-6 h-12 text-center text-red-600"
	>
		<path
			fill-rule="evenodd"
...
{:else if job.status === 'in-progress'}
	<svg
		...
		fill="none"
		viewBox="0 0 24 24"
		class="animate-spin w-6 h-12 text-center text-yellow-400"
	>
...
{:else}
	<svg
		...
		viewBox="0 0 24 24"
		fill="currentColor"
		class="w-6 h-12 text-center text-gray-600"
	>
		<path
			fill-rule="evenodd"
