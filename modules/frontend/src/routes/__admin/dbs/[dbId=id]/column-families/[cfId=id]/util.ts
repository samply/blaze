...
export const descriptions: Descriptions = {
	index: {
		...
		'tx-success-index': 'Contains successful transactions with the point in time they happend',
		...
		default: 'Contains versioning informations',
		'patient-as-of-index': 'Unused'
	},
	resource: {
