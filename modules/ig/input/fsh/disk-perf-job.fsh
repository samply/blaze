...
* input[maxConcurrency] ^definition = "The maximum number of concurrent reader threads of the random read sweep, between 1 and 1024. The sweep measures one run per concurrency level, doubling the number of readers from 1 up to the maximum. Defaults to 32."
...
Description: "The maximum concurrency is at most 1024."
Severity: #error
Expression: "value.ofType(positiveInt) <= 1024"
