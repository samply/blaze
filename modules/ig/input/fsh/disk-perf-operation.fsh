...
* parameter[+]
  ...
  * min = 0
  * max = "1"
  * documentation = "The maximum number of concurrent reader threads of the random read sweep, between 1 and 128. The sweep measures one run per concurrency level, doubling the number of readers from 1 up to the maximum. Defaults to 32."
  * type = #positiveInt
* parameter[+]
