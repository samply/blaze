    ...
    (let [entries
          [#fhir/map{:fhir/type :fhir.Bundle/entry
           ...
           #fhir/map{:fhir/type :fhir.Bundle/entry
                     ...
                     :resource
                     #fhir/map{:fhir/type :fhir/Organization
                               :id "160200"}
                     :request
                     #fhir/map{:fhir/type :fhir.Bundle.entry/request
                               :method #fhir/code "POST"
    ...
    (let [entries
          [#fhir/map{:fhir/type :fhir.Bundle/entry
                     ...
                     #fhir/map{:fhir/type :fhir/Claim
                               :id "0"
                               :diagnosis
                               [#fhir/map{:fhir/type :fhir.Claim/diagnosis
                                          :diagnosis
                                          #fhir/Reference
      ...
      (given (links/resolve-entry-links entries)
        [0 :resource :diagnosis 0 :diagnosis :reference] := #fhir/string "Condition/160146")))
    ...
    (testing "resolves the ValueSet resource"
      (let [entries
            [#fhir/map{:fhir/type :fhir.Bundle/entry
                       :fullUrl #fhir/uri "urn:uuid:44cf9905-f381-4849-8a35-79a6b29ae1b5"
                       :resource
                       #fhir/map{:fhir/type :fhir/ConceptMap
                                 :id "0"
        ...
        [#fhir/map{:fhir/type :fhir.Bundle/entry
         ...
         #fhir/map{:fhir/type :fhir.Bundle/entry
                   ...
                   #fhir/map{:fhir/type :fhir/ExplanationOfBenefit :id "0"
                             :contained
                             [#fhir/map{:fhir/type :fhir/ServiceRequest :id "0"
                                        :subject
                                        #fhir/Reference
