  ...
  (with-system [{:blaze.db/keys [node]} api-stub/mem-node-config]
    (testing "create"
      (given (bundle/assoc-tx-ops
              ...
              [(type/fhir-map {:fhir/type :fhir.Bundle/entry
                               :resource
                               (type/fhir-map {:fhir/type :fhir/Patient :id "id-220129"
        ...
        count := 1
        [0 :tx-op] := [:create #fhir/map{:fhir/type :fhir/Patient :id "id-220129"}]))
    ...
    (testing "conditional create"
      (given (bundle/assoc-tx-ops
              ...
              [(type/fhir-map {:fhir/type :fhir.Bundle/entry
                               :resource
                               (type/fhir-map {:fhir/type :fhir/Patient :id "id-220200"
                                               :meta (type/meta {:versionId #fhir/id "1"
                                                                 :lastUpdated #fhir/instant #system/date-time "1970-01-01T00:00:00Z"})})
                               :request
                               #fhir/map{:fhir/type :fhir.Bundle.entry/request
        ...
        count := 1
        [0 :tx-op] := [:create
                       #fhir/map{:fhir/type :fhir/Patient :id "id-220200"}
                       [["birthdate" "2020"]]])
      ...
      (testing "with empty :ifNoneExist"
        (given (bundle/assoc-tx-ops
          ...
          count := 1
          [0 :tx-op] := [:create #fhir/map{:fhir/type :fhir/Patient :id "id-220200"}]))
    ...
    (testing "update"
      (given (bundle/assoc-tx-ops
              ...
              [(type/fhir-map {:fhir/type :fhir.Bundle/entry
                               :resource
                               (type/fhir-map {:fhir/type :fhir/Patient :id "id-214728"
                                               :meta (type/meta {:versionId #fhir/id "1"
                                                                 :lastUpdated #fhir/instant #system/date-time "1970-01-01T00:00:00Z"})})
                               :request
                               #fhir/map{:fhir/type :fhir.Bundle.entry/request
        ...
        count := 1
        [0 :tx-op] := [:put #fhir/map{:fhir/type :fhir/Patient :id "id-214728"}])
      ...
      (testing "with precondition"
        (given (bundle/assoc-tx-ops
          ...
          count := 1
          [0 :tx-op] := [:put
                         #fhir/map{:fhir/type :fhir/Patient :id "id-214728"}
                         [:if-match 215150]])))
