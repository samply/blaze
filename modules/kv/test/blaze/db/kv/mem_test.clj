...
(deftest estimate-storage-size-test
  (with-system [{kv-store ::kv/mem} config]
    (given (kv/estimate-storage-size kv-store :foo [#blaze/byte-string"00" #blaze/byte-string"FF"])
      ::anom/category := ::anom/unsupported
      ::anom/message := "In-Memory KV Store doesn't support estimating the storage size.")))
