...
(def config
  (assoc
   ...
   {:graph-cache (ig/ref ::graph/graph-cache)
...
(deftest init-test
  ...
  (testing "invalid graph-cache"
    (given-failed-system (assoc-in config [:blaze.operation/graph :graph-cache] ::invalid)
      :key := :blaze.operation/graph
      :reason := ::ig/build-failed-spec
      [:cause-data ::s/problems 0 :via] := [::graph/graph-cache]
...
(def ^:private data-absent-reason-unsupported
  #fhir/Extension
    ...
    (with-handler [handler]
      [[[:put {:fhir/type :fhir/Patient :id "145711"}]
        [:put {:fhir/type :fhir/GraphDefinition :id "0"
               :extension
               [(extension-start :value #fhir/id"patient")
                (extension-node
                 :extension
               ...
               :start (type/code {:extension [data-absent-reason-unsupported]})}]]]
      ...
      [[[:put {:fhir/type :fhir/Patient :id "145711"}]
        ...
        [:put {:fhir/type :fhir/GraphDefinition :id "0"
               ...
               [{:fhir/type :fhir.GraphDefinition/link
                 :extension
                 [(extension-link-source-id :value #fhir/id"patient")
                  (extension-link-target-id :value #fhir/id"observation")
                  (extension-link-params :value #fhir/string"patient={ref}")]}]}]]]
      ...
      [[[:put {:fhir/type :fhir/Patient :id "145711"}]
        ...
        [:put {:fhir/type :fhir/GraphDefinition :id "0"
               ...
               [{:fhir/type :fhir.GraphDefinition/link
                ...
                {:fhir/type :fhir.GraphDefinition/link
                 :extension
                 [(extension-link-source-id :value #fhir/id"observation")
                  (extension-link-target-id :value #fhir/id"encounter")]
                 :path "encounter"}]}]]]
      ...
      [[[:put {:fhir/type :fhir/Patient :id "145711"}]
        ...
        [:put {:fhir/type :fhir/GraphDefinition :id "0"
               ...
               [{:fhir/type :fhir.GraphDefinition/link
                 :extension
                 [(extension-link-source-id :value #fhir/id"patient")
                  (extension-link-target-id :value #fhir/id"condition")
                  (extension-link-params :value #fhir/string"patient={ref}")]}
                {:fhir/type :fhir.GraphDefinition/link
                 :extension
                 [(extension-link-source-id :value #fhir/id"condition")
                  (extension-link-target-id :value #fhir/id"encounter")]
                 :path "encounter"}
                {:fhir/type :fhir.GraphDefinition/link
                 :extension
                 [(extension-link-source-id :value #fhir/id"encounter")
                  (extension-link-target-id :value #fhir/id"condition")]
