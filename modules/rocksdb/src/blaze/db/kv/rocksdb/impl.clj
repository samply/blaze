  ...
  (ColumnFamilyDescriptor.
   ...
   (cond->
    (doto (ColumnFamilyOptions.)
      ...
      (.setWriteBufferSize (* (long write-buffer-size-in-mb) u/mib))
      (.setMaxWriteBufferNumber (long max-write-buffer-number))
      (.setMaxBytesForLevelBase (* (long max-bytes-for-level-base-in-mb) u/mib))
      ...
      (.setTargetFileSizeBase (* (long target-file-size-base-in-mb) u/mib))
