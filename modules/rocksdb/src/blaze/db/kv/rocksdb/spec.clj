...
(s/def ::rocksdb/file-size-in-bytes
  nat-int?)

(s/def ::column-family-meta-data/name
  string?)

(s/def ::column-family-meta-data/file-size
  ::rocksdb/file-size-in-bytes)

(s/def ::column-family-meta-data/num-files
  nat-int?)

(s/def ::column-family-meta-data-level/level
  (s/and nat-int? #(<= % 6)))

(s/def ::column-family-meta-data-level/file-size
  ::rocksdb/file-size-in-bytes)

(s/def ::column-family-meta-data-level/num-files
  nat-int?)

(s/def ::column-family-meta-data/level
  (s/keys :req [::column-family-meta-data-level/level
                ::column-family-meta-data-level/file-size
                ::column-family-meta-data-level/num-files]))

(s/def ::column-family-meta-data/levels
  (s/coll-of ::column-family-meta-data/level))

(s/def ::rocksdb/column-family-meta-data
  (s/keys :req [::column-family-meta-data/name
                ::column-family-meta-data/file-size
                ::column-family-meta-data/num-files
                ::column-family-meta-data/levels]))
