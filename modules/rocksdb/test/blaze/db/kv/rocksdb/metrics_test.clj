  ...
  (let [collector (metrics/stats-collector {"foo" (Statistics.)})
    ...
    (testing "the metrics names are"
      (is (= ["blaze_rocksdb_block_cache_data_miss"
              ...
              "blaze_rocksdb_blocks_compression_bypassed"
              "blaze_rocksdb_blocks_compression_rejected"
              "blaze_rocksdb_compression_input_bytes"
              "blaze_rocksdb_compression_output_bytes"
              "blaze_rocksdb_compression_bypassed_bytes"
              "blaze_rocksdb_compression_rejected_bytes"
              "blaze_rocksdb_decompression_input_bytes"
              "blaze_rocksdb_decompression_output_bytes"
