...
(deftest build-graph-test
  ...
  (testing "one root concept"
    (given (graph/build-graph
      ...
      [:concepts "code-180828"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                             :code #fhir/code "code-180828"}
      :child-index := {}))
  ...
  (testing "two root concepts"
    (given (graph/build-graph
      ...
      [:concepts "code-180828"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                             :code #fhir/code "code-180828"}
      [:concepts "code-162632"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                             :code #fhir/code "code-162632"}
      :child-index := {}))
  ...
  (testing "one root and one child"
    (testing "with hierarchy"
      (given (graph/build-graph
        ...
        [:concepts "code-191445"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                               :code #fhir/code "code-191445"
                                               :property
                                               [#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
  ...
  (testing "one root, one child and one child of the child"
    (testing "with hierarchy"
      (given (graph/build-graph
        ...
        [:concepts "code-180828" :property set] := #{#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                               :code #fhir/code "child"
                                                               :value #fhir/code "code-191445"}}
        [:concepts "code-191445" :code] := #fhir/code "code-191445"
        [:concepts "code-191445" :property set] := #{#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                               :code #fhir/code "parent"
                                                               :value #fhir/code "code-180828"}
                                                     #fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                               :code #fhir/code "child"
        ...
        [:concepts "code-104304" :property set] := #{#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                               :code #fhir/code "parent"
                                                               :value #fhir/code "code-191445"}}
        :child-index := {"code-180828" #{"code-191445"}
  ...
  (testing "one child with two parents"
    (given (graph/build-graph
      ...
      [:concepts "code-183409"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                             :code #fhir/code "code-183409"
                                             :property
                                             [#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                        :code #fhir/code "child"
                                                        :value #fhir/code "code-191445"}]}
      [:concepts "code-183411"] := #fhir/map{:fhir/type :fhir.CodeSystem/concept
                                             :code #fhir/code "code-183411"
                                             :property
                                             [#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                                        :code #fhir/code "child"
...
(deftest is-a-test
  ...
  (testing "one child with two parents"
    (let [parent-1 #fhir/map{:fhir/type :fhir.CodeSystem/concept
                             :code #fhir/code "code-183409"}
          parent-2 #fhir/map{:fhir/type :fhir.CodeSystem/concept
                             :code #fhir/code "code-183411"}
          child #fhir/map{:fhir/type :fhir.CodeSystem/concept
                          :code #fhir/code "code-191445"
                          :property
                          [#fhir/map{:fhir/type :fhir.CodeSystem.concept/property
                                     :code #fhir/code "parent"
