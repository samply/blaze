(ns life-fhir-store.datomic.schema-test
  (:require
    [clojure.spec.test.alpha :as st]
    [clojure.test :refer :all]
    [juxt.iota :refer [given]]
    [life-fhir-store.datomic.schema :refer :all]
...
(comment
  (->> (life-fhir-store.structure-definition/read-structure-definitions "fhir/r4/structure-definitions")
       (vals)
